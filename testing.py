...
def test(phase):
    with torch.no_grad():
        ...
        #test_env.physics_client.resetDebugVisualizerCamera(cameraDistance=0.7, cameraYaw=135, cameraPitch=-35, cameraTargetPosition=[.6,0.6,0.4])
        #test_env.physics_client.resetDebugVisualizerCamera(cameraDistance=0.65, cameraYaw=90, cameraPitch=-60, cameraTargetPosition=[.6,0,0.4])
